_AUTOLOGIN_NAME = "$$AutoLoginName$$";
_AUTOLOGIN_PASSWORD = "$$AutoLoginPassword$$";

function _AUTOLOGIN_PREFILL()
  AccountLoginAccountEdit:SetText(_AUTOLOGIN_NAME)
  AccountLoginPasswordEdit:SetText(_AUTOLOGIN_PASSWORD)
end
...
function AccountLogin_Login()
  PlaySound("gsLogin");
  DefaultServerLogin(AccountLoginAccountEdit:GetText(),
                     AccountLoginPasswordEdit:GetText());
  AccountLoginPasswordEdit:SetText("");
