_AUTOLOIGIN_CHARACTER = "$$AutoLoginCharacter$$";

function _AUTOLOGIN()
  SelectCharacter(_AUTOLOIGIN_CHARACTER);
  EnterWorld();
end
...
function UpdateCharacterList()
  ...
  for i = 1, numChars, 1 do
    local name, race, class, level, zone, fileString, gender = GetCharacterInfo(
                                                                   i);
    if (gender == 0) then
      gender = "MALE";
    else
